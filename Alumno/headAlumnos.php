...
<head>
  ...
  <script>
    ...
    $(document).ready(function() {
      $("#datosRegisProy1").parents("#datosRegisProy").css({
        "color": "black",
    ...
    $(document).ready(function() {
      $("#hermano2").nextAll().css({
        "color": "red",
        "border": "2px solid #cccccc"
      });
    });
    $(document).ready(function() {
      $("#hermano6").nextUntil("#hermano10").css({
        "color": "red",
        "border": "2px solid #cccccc"
      });
    });
    ...
    $(document).ready(function() {
      function startAnimation() {
        $("#daPanelTestimonio").toggleClass("animated");
        $("#daPanelTestimonio").animate({
          left: '+=200px',
          height: 'toggle'
        }, 2000);
      }

      $("#daSlide").click(function() {
        startAnimation();
      });
      // Stop
      $("#daStop").click(function() {
        $("#daPanelTestimonio").stop(true, true);
      });
      // Callback
      $("#daStop").click(function() {
        alert("Detuviste la animación");
        //Chaining
        $("#daStop").fadeIn().slideUp().delay(1000).slideDown();
      });
    });

    // Reflection Ajax Zone Load
    $(document).ready(function() {
      $("#daImportante").click(function() {
        $("#div1").load("Ajax.txt", function() {
