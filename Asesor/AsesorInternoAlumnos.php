                ...
                <table id="example" class="display table-striped table-hover" style="width:100%; background-color: #ededed;">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td><input type="submit" formaction="AsesorInternoEvaluacionSeguimiento.php" value="Evaluación de Seguimiento" class="btn btn-primary"></td>
                            <td><input type="submit" formaction="AsesorInternoEvaluacionReporte.php" value="Evaluación de Reporte Final" class="btn btn-primary"></td>
                        </tr>
                    </tbody>
