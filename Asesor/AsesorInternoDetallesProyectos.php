        ...
        <legend class="legend">Datos del Proyecto</legend>
                <div class="columnaL">
                    <div class="form-row">
                        ...
                        <input type="text" class="input-estiloDG" name="NombreProyecto" value="<?php echo $ProyectoS['SPNombreProyecto']; ?>" disabled='disabled' required>
                    </div>
                    <div class="form-row">
                        <label for="ObjetivoP">Objetivo:</label>
                        <input type="text" name="ObjetivoP" value="<?php echo $ProyectoS['SPObjetivo']; ?>" disabled='disabled' required>
                    </div>
                    <div class="form-row">
                        <label for='DespripcionP'>Descripcion:</label>
                        <input type="text" name="DespripcionP" value="<?php echo $ProyectoS['SPDescripcion']; ?>" disabled='disabled' required>
                    </div>
                    <div class="form-row">
                        <label for="ImapactoP">Impacto:</label>
                        <input type="text" name="ImapactoP" value="<?php echo $ProyectoS['SPImpacto'] ?>" required disabled>
                    </div>
                    <div class="form-row">
                    <label for="LugarP">Lugar:</label>
                        <input type="text" name="LugarP" value="<?php echo $ProyectoS['SPLugar']; ?>" required disabled>
                    </div>
                </div>
                <div class="columnaC">
                    <div class="form-row">
                        <label for="Estudiantes-req">Estudiantes Requeridos:</label>
                        <input type="text" name="Estudiantes-req" value="<?php echo $ProyectoS['SPEstudiantesRequeridos']; ?>" disabled='disabled' required>
                    </div>
                    <div class="form-row">
                        <label for="TiempoP">Tiempo Estimado:</label>
                        <input type="text" name="TiempoP" value="<?php echo $ProyectoS['SDTiempoEstimado'] . ' Meses'; ?>" disabled='disabled' required>
                    </div>
                    <div class="form-row">
                        <label for="TipoP">Tipo Proyecto:</label>
                        <input type="text" name="TipoP" value="<?php echo $ProyectoS['SPTipo']; ?>" disabled='disabled' required>
                    </div>
                    <div class="form-row">
                        <label for="lineaInv">Linea de Investigacion:</label>
                        <input type="text" name="lineaInv" value="<?php echo $ProyectoS['SPLineaInvestigacion']; ?>" disabled='disabled' required>
                    </div>
                    <div class="form-row">
                        <label for="ReferenciasP">Referencias:</label>
                        <input type="text" name="ReferenciasP" value="<?php echo $ProyectoS['SPReferencias']; ?>" disabled='disabled' required>
                    </div>
                </div>
        </fieldset>
        <br>
        ...
        <legend class="legend">Datos de la empresa</legend>
                    <div class="columnaL">
                        ...
                        <div class="form-row">
                            ...
                            <input type="text" name="ramo" value="<?php echo $empresa['ramo'] ?>" disabled='disabled' required>
                        </div>
                        <div class="form-row">
                        ...
                        <div class="form-row">
                            ...
                            <input type="text" name="ESector" value="<?php echo $empresa['esector'] ?>" disabled='disabled' required>
                        </div>
                        <div class="form-row">
                    ...
                    <div class="columnaC">
                        ...
                        <label for="nombreTitular">Nombre del titular de la empresa:</label>
                            <input type="text" id="nombreTitular" value="<?php echo $empresa['enombretitular']?>" disabled='disabled' required>
                        </div>
                        <div class="form-row">
                            <label for="puestoTitular">Puesto:</label>
                            <input type="text" name="puestoTitular" value="<?php echo $empresa['epuestotitular']?>" disabled='disabled' required>
                        </div>
                        <div class="form-row">
                            <label for="nomAsesorExterno">Nombre del Asesor Externo:</label>
                            <input type="text" name="nomAsesorExterno" value="<?php echo $empresa['enombreacuerdo']?>" disabled='disabled' required>
                        </div>
                        <div class="form-row">
                            <label for="puestoAsesor">Puesto:</label>
                            <input type="text" name="puestoAsesor" value="<?php echo $empresa['epuestoacuerdo']?>" required disabled>
                        </div>
                        <div class="form-row">
                            <label for="ENombreEncargado">Nombre de la persona que firmará el acuerdo de trabajo. Estudiante- Escuela-Empresa:</label>
                            <input type="text" name="ENombreEncargado" value="<?php echo $empresa['enombreacuerdo']?>" required disabled>
                        </div> 
                    </div>
        </fieldset><br>
