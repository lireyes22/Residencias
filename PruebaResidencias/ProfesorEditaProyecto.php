...
<div class="col ms-sm-auto px-4">
	<div class="container col-9">
				...
				<div class="row">
					<div class="col">
						<label for="cantidadEstudiantes" class="form-label h6">Cantidad de
							estudiantes:</label>
						<input type="number" class="form-control" min="0" placeholder="0" value="">
					</div>
					<div class="col">
	   ...
	   <div class="d-flex justify-content-around p-4 rounded-bottom" style="background-color: #384970;">
				...
				<a href="#" class="btn btn-danger btn-lg" onclick="window.close()"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-box-arrow-right" viewBox="0 0 16 16">
