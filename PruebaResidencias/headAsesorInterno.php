...
<head>
    ...
    <link href="recursos/css/Nefta.css" type="text/css" rel="stylesheet">
    <link href="recursos/css/bootstrap.min.css" type="text/css" rel="stylesheet">
    <link href="recursos/css/jquery.dataTables.min.css" type="text/css" rel="stylesheet"> 
</head>
<body> 
    <div class="container-fluid">
        ...
        <div id="contenedor" class="row">
            <div id="menu" class="collapse collapse-horizontal bg-white menu col-sm-12 col-md-5 col-lx-4 col-xxl-2">
                <ul id="lista"  class="nav flex-column" style="width: 400px;">
                    <li class="nav-item  p-3 row">
                        <h1>Menú</h1>
                    </li>
                    <li class="nav-item p-3 my-2 row">
                        <div class="col-2 ">
                        ...
                        <div class="col-10">
                            <span class="p-1">Residencias</span>
                        </div>
                    </li>
                    <li class="nav-item p-3 my-2 row">
                        <div class="col-2">
                            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-bank" viewBox="0 0 16 16">
                                <path d="m8 0 6.61 3h.89a.5.5 0 0 1 .5.5v2a.5.5 0 0 1-.5.5H15v7a.5.5 0 0 1 .485.38l.5 2a.498.498 0 0 1-.485.62H.5a.498.498 0 0 1-.485-.62l.5-2A.501.501 0 0 1 1 13V6H.5a.5.5 0 0 1-.5-.5v-2A.5.5 0 0 1 .5 3h.89L8 0ZM3.777 3h8.447L8 1 3.777 3ZM2 6v7h1V6H2Zm2 6v1h1v-1H4Zm3 0v1h2.5v-1H7ZM9.5 6v7h1V6h-1ZM13 6v7h1V6h-1Zm2-1V4H1v1h14Zm-.39 9H1.39l-.25 1h13.72l-.25-1Z"/>
                            </svg>
                        </div>
                        <div class="col-10 ">
                    ...
                    <li class="nav-item p-3 my-2 row">
                        <div class="col-2 ">
                            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-mortarboard" viewBox="0 0 16 16">
                                ...
                                <path d="M4.176 9.032a.5.5 0 0 0-.656.327l-.5 1.7a.5.5 0 0 0 .294.605l4.5 1.8a.5.5 0 0 0 .372 0l4.5-1.8a.5.5 0 0 0 .294-.605l-.5-1.7a.5.5 0 0 0-.656-.327L8 10.466 4.176 9.032Zm-.068 1.873l.22-.748 3.496 1.311a.5.5 0 0 0 .352 0l3.496-1.311.22.748L8 12.46l-3.892-1.556Z"/>
                            </svg>
                        </div>
                        <div class="col-10 ">
                            <span class="p-1">Asesorias</span>
                        </div>
                    </li>
                    <li class="nav-item p-3 my-2 row">
                        <div class="col-2 ">
                        ...
                        <div class="col-10 ">
                            <span class="p-1">Reporte semestral</span>
                        </div>
                    </li>
                </ul>  
            </div>
